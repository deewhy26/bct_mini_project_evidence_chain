...
import CourtContract from './Court.json';
...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      uploadedImage: '',
      account: '0x2566b2A1fe2751c4403B2c4537a6D7eedCf49546'
    };
      ...
      <div>
        <div className="App">
          <header className="App-header">
            <h1 className="App-title">Evidence Collection System</h1>
          </header>
        </div>
        <div className="container">
          ...
          <EvidenceList details={this.state.transactionCompleted ? {
            ...
            details: this.state.details.description
          } : null} />
        </div>
      </div>
    );
